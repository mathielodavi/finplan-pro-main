    ...
    return (
        <div className="min-h-screen bg-surface-2 flex items-center justify-center p-8">
            <div className="text-center space-y-8 max-w-md">
                ...
                <div>
                    <h1 className="text-6xl font-black text-main tracking-tighter">404</h1>
                    <p className="text-xs font-black text-faint uppercase tracking-[0.2em] mt-3">
                        Página não encontrada
                    </p>
                    <p className="text-sm text-faint font-medium mt-4 leading-relaxed">
