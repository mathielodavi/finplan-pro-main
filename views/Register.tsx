  ...
  return (
    <AuthLayout title="Criar sua Conta" subtitle="Crie seu acesso ao Vibe Financeiro">
      <form className="space-y-4 mt-8" onSubmit={handleSubmit}>
        <div>
          <label className="block text-sm font-semibold text-main">Nome Completo</label>
          <input
            type="text"
            required
            className="mt-1 block w-full px-4 py-3 border border-subtle rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div>
          <label className="block text-sm font-semibold text-main">Email de Acesso</label>
          <input
            type="email"
            required
            className="mt-1 block w-full px-4 py-3 border border-subtle rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-semibold text-main">Senha</label>
            <input
              type="password"
              required
              className="mt-1 block w-full px-4 py-3 border border-subtle rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div>
            <label className="block text-sm font-semibold text-main">Confirmar</label>
            <input
              type="password"
              required
              className="mt-1 block w-full px-4 py-3 border border-subtle rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="text-center pt-2">
          <Link to="/login" className="text-sm font-bold text-muted hover:text-blue-600">Já tem acesso? Faça Login</Link>
        </div>
      </form>
    </AuthLayout>
  );
