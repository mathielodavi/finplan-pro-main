    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center gap-4 bg-surface py-2.5 px-4 rounded-xl border border-subtle shadow-[0_1px_2px_rgba(0,0,0,0.05)] flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setModalImport(true)} title="Importar ativos (colar dados JSON)" className="h-9 w-9 flex items-center justify-center bg-surface-2 text-faint hover:text-muted rounded-lg border border-subtle hover:bg-surface-2"><FileSpreadsheet size={15} /></button>
