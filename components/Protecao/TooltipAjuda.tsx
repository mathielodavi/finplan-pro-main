...
const TooltipAjuda: React.FC<TooltipAjudaProps> = ({ texto, className = '' }) => {
    ...
    return (
        <span className={`relative inline-flex items-center ${className}`}>
            ...
            {aberto && (
                <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-50 w-56 px-3 py-2 bg-strong text-white text-[10px] font-medium rounded-xl shadow-xl leading-relaxed">
                    {texto}
